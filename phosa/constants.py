...
PART_LABELS = {
    ...
    "skateboard": [
        (
            "models/meshes/skateboard_01_labels.json",
            {"lfholder": ['lfoot'], "rfholder": [ "rfoot"]},
        )
    ],
    "tennis": [
        (
            "models/meshes/tennis_01_labels.json",
            { "hand": ["lpalm", "rpalm"]},
        )
    ],
    "laptop": [
        (
            "models/meshes/laptop_01_labels.json",
            { "hand": ["lhand", "rhand"]},
        )
    ],
    "motorcycle": [
        (
            "models/meshes/motorcycle_01_labels.json",
            {"seat": ["butt"], "handle": ["lhand", "rhand"]},
        )
    ],
    "surfboard": [
        (
            "models/meshes/surfboard_01_labels.json",
            {"foot": ["lfoot", "rfoot"], "hand": ["lhand", "rhand"]},
        )
    ],
    "bench": [
        (
            "models/meshes/bench_01_labels.json",
            {"body_back": ["back"],"body_butt":["butt"]},
        )
    ],
    "bat": [
        (
            "models/meshes/bat_01_labels.json",
            {"handle": ["lpalm", "rpalm"]},
        )
    ]
}
